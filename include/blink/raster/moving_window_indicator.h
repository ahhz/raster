...
#include <blink/raster/circular_edge_window_view.h>
#include <blink/raster/circular_window_view.h>
#include <blink/raster/patch_raster_transform.h>
#include <blink/raster/rectangle_edge_window_view.h>
#include <blink/raster/square_window_view.h>
